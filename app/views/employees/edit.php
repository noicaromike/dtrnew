            ...
            <form action="" method="POST">
                <div class="card">
                    ...
                    <div class="form__item">
                        ...
                        <input type="text" value="<?php echo $data['EMPNAME']; ?>" name="EMPNAME" class="form__input" placeholder="Enter the full name">
                        <span class="invalidFeedback"><?php echo $data['EMPNAMEError']; ?></span>
                    </div>
                    <div class="form__item">
                        <label for="" class="form__label">Position</label>
                        <input type="text" value="<?php echo $data['POSITION']; ?>" name="POSITION" class="form__input" placeholder="Enter a position">
                        <span class="invalidFeedback"><?php echo $data['POSITIONError']; ?></span>
                    </div>
                    <div class="form__item">
                        <button class="form__btn add">Update</button>
                    </div>
