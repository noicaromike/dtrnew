            ...
            <form action="" method="POST">
                <div class="card">
                    ...
                    <!-- <div class="form__item">
                        ...
                        <input type="text" name="BNo" class="form__input" placeholder="Enter new biometric no.">
                        <span class="invalidFeedback"></span>
                    </div> -->
                    <input type="hidden" value="<?php echo $data['BNo']; ?>">
                    <div class="form__item">
                        <label for="" class="form__label">Name</label>
                        <input type="text" name="EMPNAME" value="<?php echo $data['EMPNAME']; ?>" class="form__input" placeholder="Enter the full name">
                        <span class="invalidFeedback"><?php echo $data['EMPNAMEError']; ?></span>
                    </div>
                    <div class="form__item">
                        <label for="" class="form__label">Position</label>
                        <input type="text" name="POSITION" value="<?php echo $data['POSITION']; ?>" class="form__input" placeholder="Enter a position">
                        <span class="invalidFeedback"><?php echo $data['POSITIONError']; ?></span>
                    </div>
                    <div class="form__item">
                        <button class="form__btn add">Create</button>
                    </div>
